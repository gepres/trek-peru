// Barrel export de todas las interfaces de dominio
export type { IRouteRepository } from './route/route.repository.interface';
export type { IUserRepository } from './user/user.repository.interface';
